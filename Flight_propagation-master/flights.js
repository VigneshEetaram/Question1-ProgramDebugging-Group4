...
function drawMovement(){
	...
	for(i = 0; i < arrflights.length; i++){  
        currentTime++;
        //currentTime++ should be included in for loop.
...
$(document).ready(function(){
    ...
    // Numbers dont need be given in double quotes
    var JSONObject = JSON.parse(flightJson);
	var flights = JSONObject.flights;
    //Spelling of JSONObject was incorrect "flight" to "flights".
    console.log(flights);
    ...
    {   
        ...
        //parameter as only "flight" cannot identify the individuals, so we need to give "flights[flight]" 
